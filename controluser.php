...
?>
            <tr class='text-center'>
                ...
                <td><a href="admin.php?edit_user=<?php echo $userID?>"><i class='fa-solid fa-square-pen'></i></a></td>
                <td><a href="admin.php?delete_user=<?php echo $userID?>"><i class='fa fa-trash'

...
<form action="" method="POST" class="mb-2">
    ...
    <div class="input w-90 mb-2">
        <div class="input-group flex-nowrap">
            ...
            <input type="text" class="form-control" placeholder="Last Name" name="add-lname" aria-label="Username" aria-describedby="addon-wrapping">
        </div>
    </div>
    ...
    <div class="input w-90 mb-2">
        <div class="input-group flex-nowrap">
            ...
            <input type="text" class="form-control" placeholder="Email" name="add-email" aria-label="Username" aria-describedby="addon-wrapping">
        </div>
    </div>
